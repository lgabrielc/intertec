<nav>
    ...
    <a href="/">
        <img class="absolute top-0 h-20 m-4 rounded-full sm:h-36 md:h-48" src="images/logo.jpeg" alt="red intertec">
    </a>
</nav>
<div>
    <div class="relative flex items-center justify-center -top-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            <div
                ...
                <img class="object-cover w-64 h-32 border rounded-lg border-x-slate-300" src="images/servicios/1c.jpeg"
                    alt="alertas automaticas">
            ...
            <div
                class="flex flex-col items-center w-64 p-2 mx-2 mb-2 bg-white border-2 rounded-lg shadow-lg md:mx-4 h-80 border-slate-200">
                <img class="object-cover w-64 h-32 border rounded-lg border-x-slate-300" src="images/servicios/3c.jpeg"
                    alt="software para isp">
            ...
            <div
                class="flex flex-col items-center w-64 p-2 mx-2 mb-2 bg-white border-2 rounded-lg shadow-lg md:mx-4 h-80 border-slate-200">
                <img class="object-cover w-64 h-32 border rounded-lg border-x-slate-300" src="images/servicios/4c.jpeg"
